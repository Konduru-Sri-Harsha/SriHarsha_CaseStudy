...
public class PlaneController {
	...
	@RequestMapping("/updateplane_process")
	public String updateProcess(@RequestParam("id") Integer planeId, @RequestParam("planename") String planename,
		...
		plane.setFrom(from);
		plane.setTo(to);
		boolean b=planedao.updatePlane(plane);
		if(b) {
